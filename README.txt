...
Description: Multithread Console Application simulating traffic control drones navigating through a setted route, and controlled by a central dispatcher. Each drone runs on a separate thread, and reports the zone traffic conditions if a Tube Station (csv list provided) is near.
